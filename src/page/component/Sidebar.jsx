        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav flex-column">
               ...
               <li className="nav-item">
                    <Link className="nav-link" data-toggle="collapse" aria-expanded="false" data-target="#submenu-11" aria-controls="submenu-11">
                         <i className="fab fa-fw fa-wpforms"></i>Statistique
                    </Link>
                    <div id="submenu-11" className="collapse submenu">
                         <ul className="nav flex-column">
                              <li className="nav-item"><Link to="/ClientStat" className="nav-link">Client</Link></li>
                              <li className="nav-item"><Link to="/" className="nav-link">huh</Link></li>
                         </ul>
                    </div>
               </li>
            </ul>
