        ...
        <div className="container-fluid dashboard-content">
                ...
                <div className="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active" aria-current="page">Genre</li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="row">
               <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="card">
                    <h5 class="card-header">Listes des genres</h5>
                         <div class="card-body">
                    ...
                    <div class="card">
                         ...
                         <div class="card-body">
                              ...
                              <div class="form-group">
                                   <label for="inputUserName">Genre</label>
                                   <input id="inputUserName" type="text" name="genre" data-parsley-trigger="change" required="" placeholder="" autocomplete="off" class="form-control"/>
                              </div>
                              <div class="row">
