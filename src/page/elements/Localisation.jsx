...
const Localisation = () => {
     ...
     useEffect(() => {
       axios.get('https://backspring-production-246e.up.railway.app/varotrafiaraback/localisations')
         .then(response => {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await fetch("https://backspring-production-246e.up.railway.app/varotrafiaraback/localisation", {
                 method: 'POST', 
                 headers: {
        ...
        const handleDelete = async (id) => {
          try {
            const response = await fetch(`https://backspring-production-246e.up.railway.app/varotrafiaraback/localisation?id=${id}`, {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json'
                },
                ...
                <div className="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active" aria-current="page">Localisation</li>
                    </ol>
                  </nav>
                </div>
              </div>
               ...
               <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="card">
                         ...
                         <div class="card-body">
                              ...
                              <tbody>
                              {localisation.map((localisations, index) => (
                                   <tr key={index}>
