...
const Marque = () => {
     ...
     useEffect(() => {
       axios.get('https://backspring-production-246e.up.railway.app/varotrafiaraback/marques')
         .then(response => {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await fetch("https://backspring-production-246e.up.railway.app/varotrafiaraback/marque", {
                 method: 'POST', 
                 headers: {
        ...
        const handleDelete = async (id) => {
          try {
            const response = await fetch(`https://backspring-production-246e.up.railway.app/varotrafiaraback/marque?id=${id}`, {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json'
                },
                ...
                <div className="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active" aria-current="page">Marque</li>
                    </ol>
                  </nav>
                </div>
              </div>
