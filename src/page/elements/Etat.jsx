...
const Etat = () => {
     ...
     useEffect(() => {
       axios.get('https://backspring-production-246e.up.railway.app/varotrafiaraback/etats')
         .then(response => {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await fetch("https://backspring-production-246e.up.railway.app/varotrafiaraback/etat", {
                 method: 'POST', 
                 headers: {
        ...
        const handleDelete = async (id) => {
          try {
            const response = await fetch(`https://backspring-production-246e.up.railway.app/varotrafiaraback/etat?id=${id}`, {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json'
                },
                ...
                <div className="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active" aria-current="page">Etat</li>
                    </ol>
                  </nav>
                </div>
              </div>
