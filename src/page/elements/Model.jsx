...
const Model = () => {
     ...
     useEffect(() => {
       axios.get('https://backspring-production-246e.up.railway.app/varotrafiaraback/models')
         .then(response => {
           const responseData = response.data;
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await fetch("https://backspring-production-246e.up.railway.app/varotrafiaraback/model", {
                 method: 'POST', 
                 headers: {
                         ...
                         <div class="card-body">
                              ...
                              {model.map((models, index) => (
                                   <tr key={index}>
                                        ...
                                        <th scope="row">{models.idfmarque}</th>
